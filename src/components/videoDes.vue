<template>
  <div class="video-des">
    ...
    <div class="controls">
      ...
      <i
        class="el-icon-caret-left size"
        style="left:128%;top:270px;transform:rotate(90deg);"
        @click="turnUp"
      ></i>
      <i
        class="el-icon-caret-left size"
        style="left:135%;top:310px;transform:rotate(180deg);"
        @click="turnRight"
      ></i>
      <i
        class="el-icon-caret-left size"
        style="left:128%;top:350px;transform:rotate(270deg);"
        @click="turnDown"
      ></i>
    </div>
  </div>
